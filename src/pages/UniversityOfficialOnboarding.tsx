...
=======
    setPrograms(prev => [...prev, { programName: '', language: '', minGPA: 0, tuitionFee: 0 }]);
>>>>>>> 5a8061baf3691b48b7795edb34ec7d1edb8b4051
  };
...
=======
                      <Label htmlFor={`min-gpa-${index}`}>Minimum GPA</Label>
                      <Input
                        id={`min-gpa-${index}`}
                        type="number"
                        min="0"
                        ...
                        step="0.1"
                        value={program.minGPA}
                        onChange={(event) => updateProgram(index, 'minGPA', parseFloat(event.target.value) || 0)}
                        placeholder="3.0"
                      />
>>>>>>> 5a8061baf3691b48b7795edb34ec7d1edb8b4051
                    </div>
