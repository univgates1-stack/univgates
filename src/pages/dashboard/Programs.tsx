...
=======
    (program: ProgramCardData, options: { ignoreProgramNames?: boolean; ignoreLevels?: boolean; ignoreCountries?: boolean; ignoreUniversities?: boolean } = {}) => {
>>>>>>> 5a8061baf3691b48b7795edb34ec7d1edb8b4051
...
<<<<<<< HEAD
      if (!options.ignoreMinimumGrade && minimumGradeFilter.trim()) {
        ...
        if (!Number.isNaN(parsedFilter)) {
          const programGrade = program.minimumGpa ?? -Infinity;
...
=======
    ...
    [searchQuery, selectedLevels, selectedCountries, selectedUniversities, selectedProgramNames]
>>>>>>> 5a8061baf3691b48b7795edb34ec7d1edb8b4051
  );
...
=======
      if (program.country && matchesProgramFilters(program, { ignoreCountries: true })) {
>>>>>>> 5a8061baf3691b48b7795edb34ec7d1edb8b4051
...
=======
      if (matchesProgramFilters(program, { ignoreUniversities: true })) {
>>>>>>> 5a8061baf3691b48b7795edb34ec7d1edb8b4051
...
=======
      if (matchesProgramFilters(program, { ignoreProgramNames: true })) {
>>>>>>> 5a8061baf3691b48b7795edb34ec7d1edb8b4051
...
=======
        minimumGpa: values.minimumGpa ? Number.parseFloat(values.minimumGpa) : null,
>>>>>>> 5a8061baf3691b48b7795edb34ec7d1edb8b4051
...
=======
                    <Label htmlFor="program-gpa">Minimum GPA</Label>
                    <Input
                      id="program-gpa"
                      type="number"
                      min="0"
                      ...
                      placeholder="e.g. 3.0"
                      value={formValues.minimumGpa}
                      onChange={(event) => setFormValues((prev) => ({ ...prev, minimumGpa: event.target.value }))}
                    />
>>>>>>> 5a8061baf3691b48b7795edb34ec7d1edb8b4051
                  </div>
                  <div className="space-y-2">
...
=======
                        <p className="text-muted-foreground">Minimum GPA</p>
>>>>>>> 5a8061baf3691b48b7795edb34ec7d1edb8b4051
