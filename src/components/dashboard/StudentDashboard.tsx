...
=======
import { Search, MapPin, Clock, DollarSign, GraduationCap, School, FileText, MessageSquare, BookOpen, Calendar, TrendingUp, Award } from 'lucide-react';
import { supabase } from '@/integrations/supabase/client';
...
const StudentDashboard = () => {
  ...
  const upcomingDeadlines = [
    { program: 'MIT Computer Science', deadline: '2024-03-01', daysLeft: 45 },
    { program: 'Stanford Data Science', deadline: '2024-02-15', daysLeft: 31 },
    { program: 'Oxford AI Program', deadline: '2024-06-15', daysLeft: 152 }
  ];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-primary rounded-lg p-6 text-primary-foreground">
        ...
        <p className="text-primary-foreground/90 mb-4">
          You're on track to find your dream university. Let's keep the momentum going!
>>>>>>> 5a8061baf3691b48b7795edb34ec7d1edb8b4051
        </p>
...
=======
                ...
                <p className="text-sm text-muted-foreground">500+ programs</p>
>>>>>>> 5a8061baf3691b48b7795edb34ec7d1edb8b4051
              </div>
            </div>
          </CardContent>
              ...
              {recentApplications.map((app) => (
                <div key={app.id} className="border rounded-lg p-4">
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <Badge 
                      variant={
                        app.status === 'Under Review' ? 'default' : 
                        app.status === 'Documents Required' ? 'destructive' : 'outline'
>>>>>>> 5a8061baf3691b48b7795edb34ec7d1edb8b4051
                      }
                    >
                      {app.status}
...
=======
              {upcomingDeadlines.map((deadline, index) => (
                <div key={index} className="flex items-center justify-between p-3 bg-muted rounded-lg">
                  <div>
                    <p className="font-medium text-sm">{deadline.program}</p>
