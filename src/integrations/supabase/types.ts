...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      agents: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "agents_verified_by_fkey"
            columns: ["verified_by"]
            isOneToOne: false
      ...
      student_degrees: {
        Row: {
          created_at: string | null
          degree_certificate_doc_id: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "student_degrees_degree_certificate_doc_id_fkey"
            columns: ["degree_certificate_doc_id"]
            isOneToOne: false
            referencedRelation: "documents"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "student_degrees_student_id_fkey"
            columns: ["student_id"]
            isOneToOne: false
            referencedRelation: "students"
            referencedColumns: ["id"]
      ...
      student_passports: {
        ...
        Relationships: [
          {
            foreignKeyName: "student_passports_passport_doc_id_fkey"
            columns: ["passport_doc_id"]
            isOneToOne: false
            referencedRelation: "documents"
            referencedColumns: ["id"]
          },
      ...
      university_bank_accounts: {
        ...
        Relationships: [
          {
            foreignKeyName: "university_bank_accounts_university_id_fkey"
            columns: ["university_id"]
            isOneToOne: false
            referencedRelation: "universities"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      is_university_official_for_student: {
